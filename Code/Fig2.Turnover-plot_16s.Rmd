...
intra_ro_wet_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_wet_ro.txt.csv") %>% mutate(
    qs="q0") %>% mutate(type="Wet")
intra_ro_wet_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_wet_ro.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Wet")
intra_ro_wet_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_wet_ro.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Wet")

intra_ri_wet_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_wet_ri.txt.csv") %>% mutate(
    qs="q0")%>% mutate(type="Wet")
intra_ri_wet_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_wet_ri.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Wet")
intra_ri_wet_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_wet_ri.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Wet")

intra_nr_wet_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_wet_nr.txt.csv") %>% mutate(
    qs="q0")%>% mutate(type="Wet")
intra_nr_wet_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_wet_nr.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Wet")
intra_nr_wet_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_wet_nr.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Wet")


intra_ro_dry_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_dry_ro.txt.csv") %>% mutate(
    qs="q0")%>% mutate(type="Dry")
intra_ro_dry_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_dry_ro.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Dry")
intra_ro_dry_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_dry_ro.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Dry")

intra_ri_dry_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_dry_ri.txt.csv") %>% mutate(
    qs="q0")%>% mutate(type="Dry")
intra_ri_dry_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_dry_ri.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Dry")
intra_ri_dry_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_dry_ri.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Dry")

intra_nr_dry_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_dry_nr.txt.csv") %>% mutate(
    qs="q0")%>% mutate(type="Dry")
intra_nr_dry_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_dry_nr.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Dry")
intra_nr_dry_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_dry_nr.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Dry")


intra_ro_exdry_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_exdry_ro.txt.csv") %>% mutate(
    qs="q0")%>% mutate(type="Extreme-dry")
intra_ro_exdry_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_exdry_ro.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Extreme-dry")
intra_ro_exdry_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_exdry_ro.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Extreme-dry")

intra_ri_exdry_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_exdry_ri.txt.csv") %>% mutate(
    qs="q0")%>% mutate(type="Extreme-dry")
intra_ri_exdry_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_exdry_ri.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Extreme-dry")
intra_ri_exdry_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_exdry_ri.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Extreme-dry")

intra_nr_exdry_q0<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=0-table_exdry_nr.txt.csv") %>% mutate(
    qs="q0")%>% mutate(type="Extreme-dry")
intra_nr_exdry_q1<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=1-table_exdry_nr.txt.csv") %>% mutate(
    qs="q1")%>% mutate(type="Extreme-dry")
intra_nr_exdry_q2<- read.csv(
  "../Data/Beta_diversity/Intra_Beta_Similarity-q=2-table_exdry_nr.txt.csv") %>% mutate(
    qs="q2")%>% mutate(type="Extreme-dry")
```
...
i1a<- intra_ro %>%mutate(TurnOver= 1-TurnoverComp, part="Roots") %>% filter(qs=="q0")%>%  ggpubr::ggboxplot(
  ...
  scale_y_continuous(limits = c(0, 1.25))+theme(
     strip.text.y = element_text(
        size = 16, face = "italic"
        ),
      strip.text.x = element_text(
        size = 16 ))  +stat_compare_means(comparisons = my_comparisons, label = "p.signif")+theme(axis.title.y =  element_blank())
...
my_comparisons <- list( c("Wet", "Dry"), c("Dry", "Extreme-dry") )
...
i1<-intra_ro %>%mutate(TurnOver= 1-TurnoverComp) %>%  ggpubr::ggboxplot(
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        axis.line= element_line(colour = "black"), 
        axis.line.y.right = element_line(colour = "black" ),
        axis.text = element_text(colour = "black", size = 10))+theme(axis.title.y =  element_blank())
...
my_comparisons2 <- list(  c("Wet", "Dry") )
...
my_comparisons3 <- list( c("Wet", "Extreme-dry") )
...
my_comparisons4 <- list(  c("Wet", "Extreme-dry"), c("Dry", "Extreme-dry") )
...
i3<-intra_nr%>%mutate(TurnOver= 1-TurnoverComp) %>% ggpubr::ggboxplot(
  ...
  scale_y_continuous(limits = c(0, 1.3))+theme(
     strip.text.y = element_text(
      ...
      strip.text.x = element_text(
        size = 16 ))+theme(axis.title.y =  element_blank())
my_comparisons5 <- list(  c("Wet", "Dry"), c("Dry", "Extreme-dry") )
...
my_comparisons6 <- list(  c("Dry", "Extreme-dry"), c("Wet", "Extreme-dry") )
...
i3i<- intra_nr %>%mutate(TurnOver= 1-TurnoverComp, part="Roots") %>% filter(qs=="q2")%>% 
  ...
  ylab("")+
  scale_fill_manual(values = c("#3498DB", "#F4D03F", "#E74C3C"))+
  stat_compare_means(comparisons = my_comparisons6, label = "p.signif")+
  theme_bw()+
  theme(legend.position = "none",
       # axis.ticks.x = element_blank(),
        axis.text.x = element_text(size = 14),
...
p1
ggsave(plot=p1, "Fig2.intra-turnover-paired-mod_16s.pdf", width = 10, height = 12)
